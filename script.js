...
function renderUsers(users) {
  ...
  const visibleUsers = filterItems(users, adminSearchState.players, (user) => [
    user.username,
    user.email,
    user.phone,
    user.dateOfBirth,
  ...
  visibleUsers.forEach((user) => {
    ...
    item.querySelector(".player-presence-dot").classList.add(presence.className);
    item.querySelector(".player-presence-dot").title = presence.label;
    item.querySelector(".player-presence-dot").setAttribute("aria-label", presence.label);
